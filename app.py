...
class blockchain(object):
    ...
    def verify(self):
        ...
        while (index > 0 and valid == True):
                ...
                if(currentB['header']['prev_hash']==self.data_hash(prev_B)):
                    #print (currentB['header']['prev_hash']+"CB")
                    #print(self.data_hash(prev_B)+"PV")
                    #print("finsh block")
                    currentB = prev_B
                    valid = True
                    index -= 1
                    ...
                    valid=False
                    index -= 1
                    print("falllllllllllllllllllllllllllllllllllllllllllll000000")
                
        print ("fineeeeeeeeeeeeeeeeeeeeeeeeeeeesh")
        print (valid)
        return valid
    ...
    def input_data(self,stdid,code,grade,year,seme,creator):
        ...
        tmpBlock['header']['index'] = len(self.chain)-1
...
def adding():
    ...
    if bc.load_data() == True:
    	bc.input_data(data["stdid"],data["code"],data["grade"],data["year"],data["seme"],data["owner"])
...
def uid_data(uid):
    ...
    # check existing 
    if bc.load_data() == True:
    	# if exist, response code 100 "data entry" + data chain
	    response = {
	            'res_code': 100,
	            'data': bc.chain
	        }
    else:
		# not exist , response code 101 "data not entry"
        response = {
				'res_code': 101,
				'data': ""
			}
